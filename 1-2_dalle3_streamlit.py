...
###########################
# 실행 : streamlit run 1-2.dalle3_streamlit.py
###########################
...
def get_image(prompt):
    ...
    image.save(f"output_img/dalle_image_{timestamp}.png") # 시간 데이터를 사용하여 구분지어 저장
...
# main 함수 실행
if __name__ == "__main__":  # 현재 파일이 메인 프로그램으로 실행될 때
    main()